...
check: test-spp-diag-handoff test-spp-diag-controller test-spp-diag-uart test-spp-diag-capture test-spp-diag-mapper
	...
	$(PYTHON) -m compileall -q build/spp_disk.py build/spp_appliance.py build/spp_image_sbom.py build/spp_image_sbom_check.py test/conf-proc-spp-appliance-selftest.py
