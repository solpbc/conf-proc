...
check: test-spp-diag-handoff test-spp-diag-controller test-spp-diag-uart test-spp-diag-capture test-spp-diag-mapper
	...
	$(PYTHON) -m compileall -q appliance/spp_disk.py appliance/spp_appliance.py appliance/spp_image_sbom.py appliance/spp_image_sbom_check.py appliance/populate_manifest.py appliance/acquire_boot_inputs.py test/conf-proc-spp-appliance-selftest.py
