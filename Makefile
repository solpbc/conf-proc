...
test:
	...
	$(PYTHON) test/conf-proc-spp-candidate-isolation-selftest.py
	$(PYTHON) test/conf-proc-spp-candidate-cgroups-selftest.py
	$(PYTHON) test/conf-proc-spp-candidate-attestation-selftest.py
	$(PYTHON) test/conf-proc-spp-candidate-resume-selftest.py
	...
	$(PYTHON) test/conf-proc-spp-appliance-selftest.py
	...
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-uart-selftest.py
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-capture-selftest.py
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-mapper-selftest.py
...
test-spp-diag-handoff: test-spp-diag-gpt
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-handoff-oracle-selftest.py

.PHONY: test-spp-diag-gpt test-spp-diag-handoff-static-build

test-spp-diag-gpt:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-gpt-selftest.py

test-spp-diag-handoff-static-build:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-handoff-static-build-selftest.py

test-spp-diag-controller:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-controller-selftest.py

test-spp-diag-gpu-bootstrap:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-gpu-bootstrap-selftest.py
...
test-spp-diag-capture:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-capture-selftest.py

test-spp-diag-mapper:
	PYTHONPATH=. $(PYTHON) test/conf-proc-spp-diag-mapper-selftest.py
