...
test-spp-diag-trace-core:
	...
	if nm build/spp-diag-trace-core.o | grep -Ei 'reset|inject_fault|pre_lock_barrier'; then echo "KUnit seam present in non-KUnit object"; exit 1; fi
	$(CC) $(CORE_CFLAGS) -pthread $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_TEST) -o build/spp-diag-trace-core-selftest
	./build/spp-diag-trace-core-selftest
	rm -f build/spp-diag-trace-core-selftest
	$(CC) $(CORE_CFLAGS) -pthread -DCONFIG_KUNIT=1 $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_CAPS_TEST) -o build/spp-diag-trace-core-caps-selftest
	./build/spp-diag-trace-core-caps-selftest
	rm -f build/spp-diag-trace-core-caps-selftest

test-spp-diag-trace-core-oracle:
	mkdir -p build
	$(CC) $(CORE_CFLAGS) -pthread $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_ORACLE_HARNESS) -o build/spp-diag-trace-core-oracle-harness
	$(PYTHON) $(SPP_DIAG_TRACE_CORE_ORACLE) build/spp-diag-trace-core-oracle-harness
	rm -f build/spp-diag-trace-core-oracle-harness

test-spp-diag-trace-core-race:
	mkdir -p build
	$(CC) $(CORE_CFLAGS) -pthread -DCONFIG_KUNIT=1 $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_RACE_TEST) -o build/spp-diag-trace-core-race-selftest
	./build/spp-diag-trace-core-race-selftest
	rm -f build/spp-diag-trace-core-race-selftest
	$(CC) $(CORE_CFLAGS) -pthread -DCONFIG_KUNIT=1 -DSPP_DIAG_TRACE_CORE_NOP_LOCK=1 $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_RACE_TEST) -o build/spp-diag-trace-core-race-selftest-neg
...
test-spp-diag-trace-core-sanitized:
	mkdir -p build
	$(CC) $(CORE_CFLAGS) -pthread -fsanitize=address,undefined -g -fno-sanitize-recover=undefined $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_TEST) -o build/spp-diag-trace-core-selftest-sanitized
	./build/spp-diag-trace-core-selftest-sanitized
	rm -f build/spp-diag-trace-core-selftest-sanitized
	$(CC) $(CORE_CFLAGS) -pthread -DCONFIG_KUNIT=1 -fsanitize=address,undefined -g -fno-sanitize-recover=undefined $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_CAPS_TEST) -o build/spp-diag-trace-core-caps-selftest-sanitized
	./build/spp-diag-trace-core-caps-selftest-sanitized
	rm -f build/spp-diag-trace-core-caps-selftest-sanitized
	$(CC) $(CORE_CFLAGS) -pthread -fsanitize=address,undefined -g -fno-sanitize-recover=undefined $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_ORACLE_HARNESS) -o build/spp-diag-trace-core-oracle-harness-sanitized
	...
	$(CC) $(CORE_CFLAGS) -pthread -DCONFIG_KUNIT=1 -fsanitize=address,undefined -g -fno-sanitize-recover=undefined $(SPP_DIAG_TRACE_CORE_HOST_INC) $(SPP_DIAG_TRACE_CORE_SRC) $(SPP_DIAG_TRACE_CORE_HOST_SHA) $(SPP_DIAG_TRACE_CORE_RACE_TEST) -o build/spp-diag-trace-core-race-selftest-sanitized
