...
check: test-spp-diag-controller test-spp-diag-capture test-spp-diag-mapper
	...
	$(PYTHON) -m compileall -q conf_proc_spp_diag_mapper_reasons.py conf_proc_spp_diag_mapper.py test/conf-proc-spp-diag-mapper-selftest.py
