...
check:
	$(PYTHON) -m compileall -q verifier.py ratls_contract.py ratls_collector.py ratls_gateway.py spp_health.py asr_shim.py strict_wav.py conf_proc_reasons.py conf_proc_json.py conf_proc_acl.py conf_proc_module_sig.py conf_proc_lock.py conf_proc_policy.py conf_proc_guard.py conf_proc_geometry.py conf_proc_build_images.py conf_proc_inspect_images.py conf_proc_tree_rules.py conf_proc_build_tree.py conf_proc_inspect_tree.py conf_proc_manifest.py conf_proc_build_manifest.py conf_proc_inspect_manifest.py conf_proc_sbom.py conf_proc_build_sbom.py conf_proc_inspect_sbom.py test/python-verifier-selftest.py test/fake-ratls-collector.py test/ratls-gateway-selftest.py test/spp-health-selftest.py test/asr-shim-selftest.py test/conf-proc-format-selftest.py test/conf-proc-guard-selftest.py test/conf-proc-image-selftest.py test/conf-proc-tree-selftest.py test/conf-proc-manifest-selftest.py test/conf-proc-sbom-selftest.py
