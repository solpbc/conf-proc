...
_BINDING_TYPE_TAGS_V3: Final = MappingProxyType({
    ...
    semantics.ExecutableGraphMeasuredFileNodeSnapshotV3: "graph_file",
    semantics.ExecutableGraphMeasuredDirectoryNodeSnapshotV3: "graph_directory",
    semantics.ExecutableGraphJitDerivationNodeSnapshotV3: "graph_derivation",
    semantics.ExecutableGraphJitOutputNodeSnapshotV3: "graph_output",
    semantics.ExecutableGraphAliasRowV3: "graph_alias",
    semantics.ExecutableGraphPythonLoaderRowV3: "python_loader",
    semantics.ExecutableGraphPythonLoaderDetailsSnapshotV3: "python_loader_details",
    semantics.ExecutableGraphPythonStartupControlRowV3: "python_startup_control",
    semantics.ExecutableGraphPythonLoadingControlRowV3: "python_loading_control",
    semantics.ExecutableGraphElfControlValueV3: "elf_value",
    semantics.ExecutableGraphElfControlRowV3: "elf_control",
    semantics.ExecutableGraphSourceProjectionV3: "graph_source",
    semantics.ExecutableGraphDeclarationRowV3: "graph_declaration",
    semantics.ExecutableGraphEdgeRowV3: "graph_edge",
    semantics.ExecutableGraphSnapshotV3: "executable_graph",
    ...
    tables.ResumeAnchorRowV3: "resume_anchor",
    tables.ResumeDomainRowV3: "resume_domain",
    tables.Pcr16OperationRowV3: "pcr16_operation",
    tables.SupportingMemfdRowV3: "supporting_memfd",
    tables.ResumeCallGraphRowV3: "resume_call_graph",
    tables.ResumeClosureOracleRowV3: "resume_closure_oracle",
