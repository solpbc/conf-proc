...
BOOT_PAYLOAD_SOURCE_AUTHORITY_V3: Final = (
    ...
    _SourceAuthorityV3("/usr/lib/spp/conf_proc_spp_boot_v3.py", "engine", 0o444, 35079, "0aff7ca7069da057e67dcfecc34b347945b3e7e36224510378989b52cbc35e73"),
    ...
    _SourceAuthorityV3("/usr/lib/spp/conf_proc_spp_boot_v3_semantics.py", "engine", 0o444, 58000, "04db2acddf6282c5bc556bad1704629f14db0294c0e6ed9c1a75fc88f97a5578"),
...
_EXPECTED_LITERAL_SOURCE_ROWS_V3: Final = (
    ...
    _ExpectedSourceRowV3("/usr/lib/spp/conf_proc_spp_boot_v3.py", "engine", 0o444, 35079, "0aff7ca7069da057e67dcfecc34b347945b3e7e36224510378989b52cbc35e73"),
    ...
    _ExpectedSourceRowV3("/usr/lib/spp/conf_proc_spp_boot_v3_semantics.py", "engine", 0o444, 58000, "04db2acddf6282c5bc556bad1704629f14db0294c0e6ed9c1a75fc88f97a5578"),
...
def _validate_literal_authority() -> None:
    ...
    for row in rows:
        ...
        roles[row.role] += 1
    if roles != {"support": 12, "engine": 3, "dispatcher": 1} or sum(row.size_bytes for row in rows) != 438738:
        _error(CP_SPP_PAYLOAD_V3_AUTHORITY)
