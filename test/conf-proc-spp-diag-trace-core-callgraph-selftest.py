...
ADAPTER_ENTRIES = (
    ...
    "spp_diag_trace_adapter_file_open_return",
    "spp_diag_trace_adapter_mapping_policy",
    "spp_diag_trace_adapter_mapping_return",
    "spp_diag_trace_adapter_mapping_unsupported",
    "spp_diag_trace_adapter_mprotect_policy",
    "spp_diag_trace_adapter_connect_policy",
    "spp_diag_trace_adapter_connect_return",
    "spp_diag_trace_adapter_connect_unsupported",
    "spp_diag_trace_adapter_sendmsg_policy",
    "spp_diag_trace_adapter_sendmsg_precheck",
    "spp_diag_trace_adapter_sendmsg_return",
    "spp_diag_trace_adapter_sendmsg_unsupported",
)
