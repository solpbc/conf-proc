...
static const uint8_t k_literal_a[108] = {
    0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02,
    0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x07,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xfb, 0x10, 0x20, 0x30, 0x40,
    0x50, 0x60, 0x70, 0x80, 0x90, 0xa0, 0xb0, 0xc0, 0x00, 0x00, 0x00, 0x0f,
    0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc,
    0xdd, 0xee, 0xff, 0x00, 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef};
...
static const uint8_t k_literal_b[108] = {
    ...
    0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x05,
    0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0xaa, 0xbb, 0xcc, 0xdd,
...
static const uint8_t k_preimage_zero_a[171] = {
    ...
    };
...
static const uint8_t k_preimage_zero_b[171] = {
    ...
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00,
    0x02, 0x00, 0x01, 0x00, 0x04, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00,
    0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0xaa,
    0xbb, 0xcc, 0xdd, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x11,
    0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x21, 0x22, 0x23, 0x24, 0x25,
    0x26, 0x27, 0x28};
...
static void fill_anonymous(struct spp_diag_trace_frame *f)
{
    fill_valid(f);
    store16(f->payload + 4, SPP_DIAG_TRACE_MAPPING_BACKING_ANONYMOUS);
    store32(f->payload + 24, 0);
    store32(f->payload + 28, 0);
    store32(f->payload + 32, 0);
    store32(f->payload + 36, 0);
    store64(f->payload + 40, 0);
    store64(f->payload + 48, 0);
    store64(f->payload + 56, 0);
}
...
static void fill_distinct_a(struct spp_diag_trace_frame *f)
{
    ...
    store16(f->payload + 4, SPP_DIAG_TRACE_MAPPING_BACKING_MEMFD);
    store16(f->payload + 6, SPP_DIAG_TRACE_MAPPING_MODE_PRIVATE);
    store32(f->payload + 8, 5);
    store32(f->payload + 12, 7);
    store32(f->payload + 16, 0);
    store32(f->payload + 20, 0xfffffffb);
    store32(f->payload + 24, 0x10203040);
    store32(f->payload + 28, 0x50607080);
    store32(f->payload + 32, 0x90a0b0c0);
    store32(f->payload + 36, 0x0000000f);
    store64(f->payload + 40, UINT64_C(0x1122334455667788));
    store64(f->payload + 48, UINT64_C(0x99aabbccddeeff00));
    store64(f->payload + 56, UINT64_C(0x0123456789abcdef));
}
...
static void fill_distinct_b(struct spp_diag_trace_frame *f)
{
    ...
    f->operation_ordinal = 1;
    f->phase = 1;
    store16(f->payload + 0, SPP_DIAG_TRACE_MAPPING_OPERATION_MPROTECT);
    store16(f->payload + 2, SPP_DIAG_TRACE_POLICY_ALLOW);
    store16(f->payload + 4, SPP_DIAG_TRACE_MAPPING_BACKING_OTHER);
    store16(f->payload + 6, SPP_DIAG_TRACE_MAPPING_MODE_SHARED);
    store32(f->payload + 8, 4);
    store32(f->payload + 12, 5);
    store32(f->payload + 16, 3);
    store32(f->payload + 20, 0);
    store32(f->payload + 24, 0xaabbccdd);
    store32(f->payload + 28, 0x11223344);
    store32(f->payload + 32, 0x55667788);
    store32(f->payload + 36, 0);
    store64(f->payload + 40, UINT64_C(0x0102030405060708));
    store64(f->payload + 48, UINT64_C(0x1112131415161718));
    store64(f->payload + 56, UINT64_C(0x2122232425262728));
}
...
static void apply_legal_tuple(struct spp_diag_trace_frame *f, uint16_t operation,
                              uint16_t decision, uint16_t backing, uint16_t mode)
{
    fill_valid(f);
    store16(f->payload + 0, operation);
    store16(f->payload + 2, decision);
    store16(f->payload + 4, backing);
    store16(f->payload + 6, mode);
    if (decision == SPP_DIAG_TRACE_POLICY_DENY) {
        store32(f->payload + 20, 0x80000000u);
    }
...
static int expect_u16_swap(const struct spp_diag_trace_frame *base, size_t poff_a,
                           size_t poff_b, int swapped_expect)
{
    ...
    orig = *base;
    swapped = *base;
    memcpy(ta, orig.payload + poff_a, 2);
    memcpy(tb, orig.payload + poff_b, 2);
    memcpy(swapped.payload + poff_a, tb, 2);
    memcpy(swapped.payload + poff_b, ta, 2);
    layout_frame(wo, &orig);
    layout_frame(ws, &swapped);
    EXPECT(memcmp(ws, wo, 108) != 0);
    EXPECT_MEM_EQ(ws + 44 + poff_a, wo + 44 + poff_b, 2);
    EXPECT_MEM_EQ(ws + 44 + poff_b, wo + 44 + poff_a, 2);
    if (swapped_expect == WIRE_OK) {
        CALL(expect_ok_both_paths(&swapped));
    } else {
        CALL(cheap_fail_struct(&swapped, swapped_expect));
    }
    return 0;
}
...
static void pp_backing0(struct spp_diag_trace_frame *f)
{
    store16(f->payload + 4, 0);
}
static void pp_mode0(struct spp_diag_trace_frame *f)
{
    store16(f->payload + 6, 0);
}
static void pp_req_unk(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 8, 0x8);
}
static void pp_eff_unk(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 12, 0x8);
}
static void pp_prior_unk(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 16, 0x8);
}
static void pp_eff_no_exec(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 12, 0);
}
static void pp_mmap_prior(struct spp_diag_trace_frame *f)
{
...
static void pp_seals_nz(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 36, 1);
}
...
static void pp_fs_nz(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 24, 1);
}
static void pp_major_nz(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 28, 1);
}
static void pp_minor_nz(struct spp_diag_trace_frame *f)
{
    store32(f->payload + 32, 1);
}
static void pp_inode_nz(struct spp_diag_trace_frame *f)
{
    store64(f->payload + 40, 1);
}
static void pp_mount_nz(struct spp_diag_trace_frame *f)
{
    store64(f->payload + 48, 1);
}
static void pp_size_nz(struct spp_diag_trace_frame *f)
{
    store64(f->payload + 56, 1);
}
...
static int test_compatibility(void)
{
    ...
    EXPECT_EQ(SPP_DIAG_TRACE_PROVENANCE_EVENT_EXEC_MAPPING_POLICY_DECISION,
              0x0102);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_OPERATION_MMAP, 1);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_OPERATION_MPROTECT, 2);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_BACKING_ANONYMOUS, 1);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_BACKING_REGULAR, 2);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_BACKING_MEMFD, 3);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_BACKING_OTHER, 4);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_MODE_SHARED, 1);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_MODE_PRIVATE, 2);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_PROT_READ, 1);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_PROT_WRITE, 2);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_PROT_EXEC, 4);
    EXPECT_EQ(SPP_DIAG_TRACE_MAPPING_PROT_MASK, 7);
    EXPECT_EQ(SPP_DIAG_TRACE_EXEC_MAPPING_POLICY_DECISION_PAYLOAD_SIZE, 64);
                             ...
                             const uint8_t *prenz)
{
    ...
    EXPECT_EQ(decoded.f.event_type, 0x0102);
...
static int test_literals(void)
{
    ...
    EXPECT_EQ(sizeof k_preimage_zero_b, (size_t)171);
    EXPECT_EQ(sizeof k_preimage_nz_b, (size_t)171);
    ...
    EXPECT_EQ(spp_diag_trace_provenance_frame_encode(&f, got, sizeof got,
                                                     &written, &required),
              WIRE_OK);
    EXPECT_MEM_EQ(got + 84, k_literal_a + 84, 8);
    EXPECT_MEM_EQ(got + 92, k_literal_a + 92, 8);
    EXPECT(memcmp(got + 84, got + 92, 8) != 0);

    store64(f.payload + 40, UINT64_C(0x99aabbccddeeff00));
    store64(f.payload + 48, UINT64_C(0x1122334455667788));
    EXPECT_EQ(spp_diag_trace_provenance_frame_encode(&f, got, sizeof got,
                                                     &written, &required),
              WIRE_OK);
    EXPECT(memcmp(got, k_literal_a, 108) != 0);
    EXPECT_MEM_EQ(got + 84, k_literal_a + 92, 8);
    EXPECT_MEM_EQ(got + 92, k_literal_a + 84, 8);
...
{
    struct spp_diag_trace_frame f, hybrid;
    unsigned operation;
    unsigned decision;
    unsigned backing;
    unsigned mode;
    ...
    for (decision = 1; decision <= 2; decision++) {
        for (ri = 0; ri < sizeof results / sizeof results[0]; ri++) {
            ...
            store32(f.payload + 20, results[ri]);
    ...
    store32(f.payload + 36, 0);
    CALL(expect_ok_both_paths(&f));
    store32(f.payload + 36, UINT32_MAX);
    CALL(expect_ok_both_paths(&f));
    store32(f.payload + 24, 0);
    store32(f.payload + 28, 0);
    store32(f.payload + 32, 0);
    store64(f.payload + 56, 0);
    CALL(expect_ok_both_paths(&f));
    store32(f.payload + 24, UINT32_MAX);
    store32(f.payload + 28, UINT32_MAX);
    store32(f.payload + 32, UINT32_MAX);
    store64(f.payload + 56, UINT64_MAX);
    CALL(expect_ok_both_paths(&f));
    store64(f.payload + 40, 0);
    CALL(cheap_fail_struct(&f, WIRE_VALUE));
    fill_valid(&f);
    ...
    for (backing = SPP_DIAG_TRACE_MAPPING_BACKING_REGULAR;
        ...
        fill_valid(&f);
        store16(f.payload + 4, (uint16_t)backing);
        store32(f.payload + 36, 0);
        CALL(expect_ok_both_paths(&f));
        store32(f.payload + 36, 1);
        CALL(cheap_fail_struct(&f, WIRE_FLAGS));
        ...
        store64(f.payload + 48, UINT64_MAX);
        CALL(expect_ok_both_paths(&f));
        store64(f.payload + 40, 0);
        CALL(cheap_fail_struct(&f, WIRE_VALUE));
        fill_valid(&f);
    ...
    for (v = 0; v <= 15; v++) {
        ...
        fill_valid(&f);
        store32(f.payload + 12, v);
        if ((v & ~7u) != 0) {
            CALL(cheap_fail_struct(&f, WIRE_FLAGS));
        } else if ((v & SPP_DIAG_TRACE_MAPPING_PROT_EXEC) == 0) {
            CALL(cheap_fail_struct(&f, WIRE_STATE));
        } else {
            CALL(expect_ok_both_paths(&f));
        }
        fill_valid(&f);
        store32(f.payload + 16, v);
        if ((v & ~7u) != 0) {
            CALL(cheap_fail_struct(&f, WIRE_FLAGS));
        } else if (v != 0) {
            CALL(cheap_fail_struct(&f, WIRE_STATE));
    ...
    fill_valid(&f);
    store32(f.payload + 8, UINT32_MAX);
    CALL(cheap_fail_struct(&f, WIRE_FLAGS));
    fill_valid(&f);
    ...
    for (bit = 3; bit < 32; bit++) {
        uint32_t unk = 1u << bit;
        fill_valid(&f);
        store32(f.payload + 8, unk);
        CALL(cheap_fail_struct(&f, WIRE_FLAGS));
        fill_valid(&f);
        store32(f.payload + 12, unk);
        CALL(cheap_fail_struct(&f, WIRE_FLAGS));
        fill_valid(&f);
        store32(f.payload + 16, unk);
        CALL(cheap_fail_struct(&f, WIRE_FLAGS));
    }
    ...
    for (v = 0; v <= 0xffffu; v++) {
        ...
        if (v == SPP_DIAG_TRACE_MAPPING_OPERATION_MMAP ||
            v == SPP_DIAG_TRACE_MAPPING_OPERATION_MPROTECT) {
            CALL(expect_ok_both_paths(&f));
        } else {
            CALL(cheap_fail_struct(&f, WIRE_STATE));
        }
    ...
    for (v = 0; v <= 0xffffu; v++) {
        ...
        if (v >= SPP_DIAG_TRACE_MAPPING_BACKING_ANONYMOUS &&
            v <= SPP_DIAG_TRACE_MAPPING_BACKING_OTHER) {
            if (v == SPP_DIAG_TRACE_MAPPING_BACKING_ANONYMOUS) {
                store64(f.payload + 40, 0);
                store64(f.payload + 48, 0);
            }
    ...
    for (v = 0; v <= 0xffffu; v++) {
        ...
        if (v == SPP_DIAG_TRACE_MAPPING_MODE_SHARED ||
            v == SPP_DIAG_TRACE_MAPPING_MODE_PRIVATE) {
            CALL(expect_ok_both_paths(&f));
        } else {
            CALL(cheap_fail_struct(&f, WIRE_STATE));
        }
    ...
    fill_distinct_a(&f);
    CALL(expect_u16_swap(&f, 0, 2, WIRE_VALUE));
    CALL(expect_u16_swap(&f, 0, 4, WIRE_STATE));
    CALL(expect_u16_swap(&f, 0, 6, WIRE_OK));
    CALL(expect_u16_swap(&f, 2, 4, WIRE_STATE));
    CALL(expect_u16_swap(&f, 4, 6, WIRE_STATE));
    hybrid = f;
    store16(hybrid.payload + 6, SPP_DIAG_TRACE_MAPPING_MODE_SHARED);
    CALL(expect_ok_both_paths(&hybrid));
    CALL(expect_u16_swap(&hybrid, 2, 6, WIRE_VALUE));
    return 0;
}
...
static int test_bounds(void)
{
    ...
    const struct step steps[] = {
        ...
        {"backing", pp_backing0, WIRE_STATE, 48, 2, SOFF(payload) + 4, 2},
        {"mode", pp_mode0, WIRE_STATE, 50, 2, SOFF(payload) + 6, 2},
        {"req", pp_req_unk, WIRE_FLAGS, 52, 4, SOFF(payload) + 8, 4},
        {"eff-mask", pp_eff_unk, WIRE_FLAGS, 56, 4, SOFF(payload) + 12, 4},
        {"prior-mask", pp_prior_unk, WIRE_FLAGS, 60, 4, SOFF(payload) + 16, 4},
        /*
         * Cross-field checks re-read earlier payload words after prior is
         * loaded, so they are not valid ASan later-field poison targets.
         */
        {"eff-exec", pp_eff_no_exec, WIRE_STATE, 56, 0, SOFF(payload) + 12, 0},
        {"mmap-prior", pp_mmap_prior, WIRE_STATE, 60, 0, SOFF(payload) + 16, 0},
        {"result", pp_result_bad, WIRE_VALUE, 64, 4, SOFF(payload) + 20, 4},
